...
module.exports = (robot) ->
  robot.respond /chess me$/i, (msg) ->
    ...
    boardToFen robot.brain.data.chess.getStatus(), (status, fen) ->
      msg.send 'http://webchess.freehostia.com/diag/chessdiag.php?fen=' + encodeURIComponent(fen) + '&size=large&coord=yes&cap=no&stm=yes&fb=no&theme=merida&format=auto&color1=ffffff&color2=c9c9c9&color3=000000&.png'
